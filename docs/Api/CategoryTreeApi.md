# Swagger\EbayTaxonomyClient\CategoryTreeApi
...
```php
fetchItemAspects($category_tree_id): \Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse
```
...
[**\Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse**](../Model/GetCategoriesAspectResponse.md)
...
```php
getCategorySubtree($category_id, $category_tree_id): \Swagger\EbayTaxonomyClient\Model\CategorySubtree
```
...
[**\Swagger\EbayTaxonomyClient\Model\CategorySubtree**](../Model/CategorySubtree.md)
...
```php
getCategorySuggestions($category_tree_id, $q): \Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse
```
...
[**\Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse**](../Model/CategorySuggestionResponse.md)
...
```php
getCategoryTree($category_tree_id): \Swagger\EbayTaxonomyClient\Model\CategoryTree
```
...
[**\Swagger\EbayTaxonomyClient\Model\CategoryTree**](../Model/CategoryTree.md)
...
```php
getCompatibilityProperties($category_tree_id, $category_id): \Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse
```
...
[**\Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse**](../Model/GetCompatibilityMetadataResponse.md)
...
```php
getCompatibilityPropertyValues($category_tree_id, $compatibility_property, $category_id, $filter): \Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse
```
...
[**\Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse**](../Model/GetCompatibilityPropertyValuesResponse.md)
...
```php
getDefaultCategoryTreeId($marketplace_id, $accept_language): \Swagger\EbayTaxonomyClient\Model\BaseCategoryTree
```
...
[**\Swagger\EbayTaxonomyClient\Model\BaseCategoryTree**](../Model/BaseCategoryTree.md)
...
```php
getItemAspectsForCategory($category_id, $category_tree_id): \Swagger\EbayTaxonomyClient\Model\AspectMetadata
```
...
[**\Swagger\EbayTaxonomyClient\Model\AspectMetadata**](../Model/AspectMetadata.md)
