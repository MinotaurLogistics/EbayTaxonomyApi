...
namespace Swagger\EbayTaxonomyClient\GeneratedApi;
...
use Swagger\EbayTaxonomyClient\ApiException;
use Swagger\EbayTaxonomyClient\Configuration;
use Swagger\EbayTaxonomyClient\HeaderSelector;
...
class CategoryTreeApi
{
     ...
     *
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchItemAspectsWithHttpInfo($category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\GetCategoriesAspectResponse',
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\CategorySubtree
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\CategorySubtree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategorySubtreeWithHttpInfo($category_id, $category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\CategorySubtree' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\CategorySubtree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\CategorySubtree';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\CategorySubtree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategorySuggestionsWithHttpInfo($category_tree_id, $q)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\CategorySuggestionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\CategoryTree
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\CategoryTree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryTreeWithHttpInfo($category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\CategoryTree' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\CategoryTree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\CategoryTree';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\CategoryTree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompatibilityPropertiesWithHttpInfo($category_tree_id, $category_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\GetCompatibilityMetadataResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompatibilityPropertyValuesWithHttpInfo($category_tree_id, $compatibility_property, $category_id, $filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\GetCompatibilityPropertyValuesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\BaseCategoryTree
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\BaseCategoryTree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDefaultCategoryTreeIdWithHttpInfo($marketplace_id, $accept_language = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\BaseCategoryTree' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\BaseCategoryTree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\BaseCategoryTree';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\BaseCategoryTree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayTaxonomyClient\Model\AspectMetadata
     */
     ...
     * @throws \Swagger\EbayTaxonomyClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayTaxonomyClient\Model\AspectMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemAspectsForCategoryWithHttpInfo($category_id, $category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayTaxonomyClient\Model\AspectMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayTaxonomyClient\Model\AspectMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayTaxonomyClient\Model\AspectMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayTaxonomyClient\Model\AspectMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
