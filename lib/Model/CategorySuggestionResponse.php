...
class CategorySuggestionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'category_suggestions' => '\Swagger\EbayTaxonomyClient\Model\CategorySuggestion[]',
     ...
     *
     * @return \Swagger\EbayTaxonomyClient\Model\CategorySuggestion[]|null
     */
     ...
     *
     * @param \Swagger\EbayTaxonomyClient\Model\CategorySuggestion[]|null $category_suggestions Contains details about one or more suggested categories that correspond to the provided keywords. The array of suggested categories is sorted in order of eBay's confidence of the relevance of each category (the first category is the most relevant). Important: This call is not supported in the Sandbox environment. It will return a response payload in which the categoryName fields contain random or boilerplate text regardless of the query submitted.
     *
     * @return self
     */
