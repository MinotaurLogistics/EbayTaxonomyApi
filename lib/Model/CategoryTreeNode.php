...
class CategoryTreeNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'child_category_tree_nodes' => '\Swagger\EbayTaxonomyClient\Model\CategoryTreeNode[]',
     ...
     *
     * @return \Swagger\EbayTaxonomyClient\Model\CategoryTreeNode[]|null
     */
     ...
     *
     * @param \Swagger\EbayTaxonomyClient\Model\CategoryTreeNode[]|null $child_category_tree_nodes An array of one or more category tree nodes that are the immediate children of the current category tree node, as well as their children, recursively down to the leaf nodes. Returned only if the current category tree node is not a leaf node (the value of leafCategoryTreeNode is false).
     *
     * @return self
     */
