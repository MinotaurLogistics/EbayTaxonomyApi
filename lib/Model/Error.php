...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\Swagger\EbayTaxonomyClient\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \Swagger\EbayTaxonomyClient\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \Swagger\EbayTaxonomyClient\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
